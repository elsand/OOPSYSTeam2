...
Public Class frmSaleMain
    ...
    Public Overrides Sub OnFormGetsForeground()
        OrderBindingSource.DataSource = DBM.Instance.Orders.Where(Function(o) o.isSubscriptionOrder = False).OrderByDescending(Function(o) o.modified).Take(10).ToList()
        CustomerBindingSource.DataSource = DBM.Instance.Customers.OrderByDescending(Function(c) c.modified).Take(10).ToList()
    End Sub
